...
public class FreelistingTestCases extends Homepage {
	...
	public void launch() throws InterruptedException, IOException{
		...
		Homepage.takescreenshotoffreelisting(driver,"defaultlocation");
		driver.findElement(By.xpath("//*[@id='city']")).sendKeys(prop.getProperty("location"));
		Homepage.takescreenshotoffreelisting(driver,"changedlocation");
		Thread(3);
		visibilitywaitwithclick("//ul[@id='cuto']/li", 100);
		Homepage.takescreenshotoffreelisting(driver,"selectingfreelisting");
    ...
    @Test(priority=2)
    public void allNullValues() throws InterruptedException, IOException {
    	obj.elements();
    	ExtentTest test2 = report.createTest("All NullValues","Testing Freelisting Page with all Null values");
    	obj.cityname.clear();
    	obj.submit.click();
    	Homepage.takescreenshotoffreelisting(driver,"nullvalues");
	...
	public void companyNullValue(String company, String fname, String lname, String mobile, String land) throws InterruptedException, IOException{
		obj.elements();
		...
		Homepage.takescreenshotoffreelisting(driver,"companynullvalue");
		String alert = driver.findElement(By.xpath("//span[@class='almsg']")).getText();
	...
	public void mobileNullValue(String company, String fname, String lname, String mobile, String land) throws InterruptedException, IOException{
		obj.elements();
		...
		Homepage.takescreenshotoffreelisting(driver,"mobilenullvalue");
		driver.navigate().refresh();
	...
	public void cityNullvalue(String company, String fname, String lname, String mobile, String land) throws InterruptedException, IOException{
		obj.elements();
		...
		obj.submit.click();
		Homepage.takescreenshotoffreelisting(driver,"citynullvalue");
		Thread(3);
	...
	public void validDataTest(String company, String fname, String lname, String mobile, String land) throws InterruptedException, IOException {
		obj.elements();
		...
		obj.landline.sendKeys(land);
		obj.submit.click();	
		Homepage.takescreenshotoffreelisting(driver,"validdetails");
		...
		Homepage.takescreenshotoffreelisting(driver,"validsearchresults");
