...
public class HomepageTestCases extends Homepage{
        ...
        public void loginPageTest() throws InterruptedException, IOException {
        	...
        	Homepage.takescreenshotofhomepage(driver,"login");
        ...
        public void locationTest() throws InterruptedException, IOException {
    		...
    		Thread(2);
    		Homepage.takescreenshotofhomepage(driver,"changedlocation");
        ...
        public void searchingTest() throws InterruptedException, IOException {
        	...
        	Homepage.takescreenshotofhomepage(driver,"carserviceselected");
        	driver.findElement(By.xpath("//*[@id='srIconwpr']")).click();
        	test.info("search button is clicked");
        	Homepage.takescreenshotofhomepage(driver,"searchresults");
        ...
        public void bestdealsTest() throws InterruptedException, IOException {
        	...
        	Homepage.takescreenshotofhomepage(driver,"bestdealsclicked");
        ...
        public void printData() throws InterruptedException, IOException {
        	...
        	Homepage.takescreenshotofhomepage(driver,"changedresults");
       ...
       @Test(priority=10)
       public void dataFromMenubar() throws InterruptedException, IOException {
   		...
   		Homepage.takescreenshotofhomepage(driver,"automobileserviceselected");
   		...
   		Homepage.takescreenshotofhomepage(driver,"serviceselectedinautomobile");
