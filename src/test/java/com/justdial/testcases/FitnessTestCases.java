...
public class FitnessTestCases extends Homepage {
	...
	public void fitness() throws InterruptedException, IOException {
		...
		element1.clear();
		Homepage.takescreenshot(driver,"defaultlocation");
		Thread(3);
		WebElement element2=driver.findElement(By.xpath("//*[@id='city']"));
		element2.sendKeys(prop.getProperty("location"));
		test1.info("The City Is Selected In The HomePage");
		Homepage.takescreenshot(driver,"changedlocation");
		Thread(3);
		visibilitywaitwithclick("//ul[@id='cuto']/li", 100);
		Homepage.takescreenshot(driver,"serviceselected");
	...
	@Test(priority=2)
	public void fitnessMenu() throws InterruptedException, IOException {
		...
		Homepage.takescreenshot(driver,"servicesinfitness");
	...
	public void gym() throws InterruptedException, IOException {
		...
		Homepage.takescreenshot(driver,"servicesselectedinfitness");
	...
	@Test(priority = 4)
	public void gymMenu() throws InterruptedException, IOException {
		...
		Homepage.takescreenshot(driver,"servicesingyms");
